...
HD_PWD='C:/Users/30694/VHDL_FINAL/VHDL_FINAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dice_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dice_game.tcl -notrace
