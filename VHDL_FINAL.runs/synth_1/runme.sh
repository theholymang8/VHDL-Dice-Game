...
HD_PWD='C:/Users/30694/VHDL_FINAL/VHDL_FINAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dice_game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dice_game.tcl
